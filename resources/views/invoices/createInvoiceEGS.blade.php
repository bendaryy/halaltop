                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input class="form-control" placeholder=" @lang("
                                                                ...
                                                                name="discountAmount[]" value="0" id="discountAmount"
                                                                onkeyup="bigOne()"
                                                                onmouseover="bigOne()">
                                                        </div>
                                                        <div class="col-md-6">
                            ...
                            <div class="col-lg-4" style="margin-top: -120px">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="salesTotal" class="form-label">إجمالى الخصومات</label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="TotalDiscount" class="form-label">إجمالى خصومات الأصناف</label>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="number" class="form-control" step="any" name="ExtraDiscount"
                                                id="ExtraDiscount" onkeyup="bigOne()" value="0"
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" placeholder=" @lang("site.Discount")" type="number" step="any"
                                            name="discountAmount[]" value="0" id="discountAmount${i}"
                                            onkeyup="bigOne${i}(),bigOne();"
                                            onmouseover="bigOne${i}(),bigOne();">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="lineDiscountAfterTax" class="form-label">@lang("site.Discount_After_Tax") </label>
                                        <input type="number" class="form-control" step="any" name="itemsDiscount[]" value="0" id="itemsDiscount${i}"
                                            onkeyup="bigOne${i}(),bigOne();"
                                            onmouseover="bigOne${i}(),bigOne();"
                                            placeholder="@lang("site.Discount_After_Tax")">
                                    </div>
